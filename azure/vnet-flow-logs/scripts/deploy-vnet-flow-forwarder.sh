...
FUNC_DIR="$PROJECT_ROOT/azure/vnet-flow-logs/function/vnet-flow-forwarder"
...
FUNC_APP_NAME="${AZURE_FUNC_APP_NAME:-vnet-flow-forwarder}"
FUNC_STORAGE="${AZURE_FUNC_STORAGE:-lmfuncstore}"
...
echo "VNet Flow Log:       vnet-flow-log"
echo ""
