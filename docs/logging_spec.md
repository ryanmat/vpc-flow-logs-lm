# Multi-Cloud Network Logging and Cost Attribution POC - Technical Specification

## Overview

This document specifies the technical requirements for building a LogicMonitor-based network monitoring and cost attribution solution for Product Engineering across Azure and AWS environments.
