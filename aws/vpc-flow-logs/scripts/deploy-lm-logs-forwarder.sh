#!/usr/bin/env bash
# Description: Deploys the LM Logs Forwarder Lambda via CloudFormation.
# Description: Uses LogicMonitor's official CF template with a project-specific function name.
...
# Project-specific names to avoid conflicts with other deployments in this account
...
echo "=== Deploying LM Logs Forwarder ==="
