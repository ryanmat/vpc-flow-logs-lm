...
echo ""
echo "[3/3] Checking KPMGLMLogsForwarder Lambda invocations..."
END_TIME=$(date +%s)
...
INVOCATIONS=$(aws cloudwatch get-metric-statistics \
    ...
    --dimensions Name=FunctionName,Value=KPMGLMLogsForwarder \
...
echo "  - Check Lambda CloudWatch logs: /aws/lambda/KPMGLMLogsForwarder"
